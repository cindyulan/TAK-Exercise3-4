...
'Melakukan klik button login tanpa menginputkan username dan password'
WebUI.click(findTestObject('Web Record/Login Object/button_login'))

'Memastikan validasi gagal login muncul'
WebUI.verifyElementVisible(findTestObject('Web Record/Login Object/text_login_failed'))
